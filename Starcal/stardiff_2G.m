function [diff] = stardiff_2G(fv,x,y,starmat,x0,y0,d_x0y0)
% STARDIFF_2G - total error of starfield fit.
% 
% STARDIFF_2G calculates the sum of the square of deviation of 
