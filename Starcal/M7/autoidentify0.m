function [idstarsok,stars_par] = autoidentify0(SkMp)
...
for i = 1:imax,
  ...
  if ( ( 1 < x0 & x0 < bx ) & ( 1 < y0 & y0 < by ) )
    ...
    starpar = fminsearch(@(startvec) stardiff2(startvec,xStar,yStar,starmat-bakgr2,x0,y0),startvec);
