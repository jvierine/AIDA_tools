...
if mode < 0
  ...
  if ( exist('fminunc','file') )
    ...
    optpar = fminunc('automat2',startpar,[],[],identstars,mode,sp2,locked_par,size(SkMp.img));
    
  elseif ( exist('fminubg','file'))
    
    optpar = fminubg('automat2',startpar,[],[],identstars,mode,sp2,locked_par,size(SkMp.img));
    
  else
    
    optpar = fminsearch('automat2',startpar,optimset,identstars,mode,sp2,locked_par,size(SkMp.img));
    %optpar = fminsearch('automat2',startpar,[],[],identstars,mode,sp2,locked_par);
    %optpar = fminsearch('automat2',startpar,[],[],identstars,mode,sp2,locked_par,size(SkMp.img));
