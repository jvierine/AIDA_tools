...
prefs.sz_z_r     = 10;                       % Side length of zoom region [dl] (pixels)
prefs.pl_sz_st   = max(1,round(15*q_sc_sz)); % Plot-size of stars
...
prefs.cl_st_pt   = 'r';                      % Colour of star-point-mark
prefs.sz_er_pt   = 10;                       % Size of error-point-mark
prefs.cl_er_pt   = 'r';                      % Colour of error-point-mark
prefs.sc_er_ar   = 10;                       % Length scaling of error arrows
...
prefs.pl_cl_bg   = [1 1 1];                  % Background colour of sky window
prefs.cmp_sky    = bone;
prefs.cmp_zoom   = viridis;
