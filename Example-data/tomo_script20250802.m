...
% tomo20080305FinalIR_082011.m  tomo20080305NewBeginnings.m   
% edit tomo20080305NewBeginnings.m
% homedir
% 
% homedir =
% 
% /bira-iasb/home/cyrils/
% 
% Uname
% 
% Uname =
...
% cd(data_dir);
% {Error using cd
% Cannot CD to /home/bgu001projects/ALIS/stdnames/ (Name is nonexistent or not a directory).
% } 
% cd /bigdata/alis/stdnames/
% ls
% 1993  1994  1995  1996	1997  1998  1999  2000	2001  2002  2003  2004	2007  2009  2011  2012	2013  2014  2015  du.txt
% 
% data_dir = pwd;
% cd
% 
% /bigdata/alis/stdnames
% 
% 
% Example-data/  Examples/      
% cd ~/AIDA_tools/Examples/
% ls
% ADA_1_loadnpreproc_p.m	ada_ex_imgs_keograms.m	html			     mapping_example_Geo_n_mag.m  sotonICems2ProductionProfileMatrix.m	to_gopta_explained.m	     tomo_EXMPL970216.m
% ada_ex_img_mmmm.m	ada_ex_imgs_show.m	keogramming_example_magLL.m  opt_mech_vign.m		  stdposEISCAT2_200506.m		tomo20080305NewBeginnings.m
% 
...
% $$$   caxis(cX{i1})
% $$$ end
% $$$ {Error using fastprojection (line 24)
% $$$ size of 3-D block-of-blobs does not match size of camera setup: 100 100 74 (in) vs 1
% $$$ } 
% $$$ 
% $$$ 
% $$$ size(X)
...
% $$$      1
% $$$ 
% $$$ which camera_set_up_sc
% $$$ /home/bgu001/AIDA_tools/Tomography/camera_set_up_sc.m
% $$$ size(X)
% $$$ 
% $$$ ans =
% $$$ 
