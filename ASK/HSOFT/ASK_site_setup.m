...
% This was pre 20181112:
% $$$ data_directory = '/media/ALIS_USB_2012-2/ASK';
% $$$ videodir       = '/media/ALIS_USB_2012-2/ASK';
% $$$ HDIR           = '/data/bjg1c10/ASK/';
% $$$ 
% $$$ ASKLUTfile     = '/data/ask/data/setup/ask.lut';
% data_directory = '/bigdata/ASK/';
% videodir       = '/bigdata/ASK/';
% HDIR           = '/bigdata/ASK/';

data_directory = '/mnt/data/bjorn/ASK';
videodir       = '/mnt/data/bjorn/ASK';
HDIR           = '/mnt/data/bjorn/ASK';
ASKLUTfile     = '/mnt/data/bjorn/ASK/setup/ask.lut';
