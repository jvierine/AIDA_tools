function [keos,imstack,timeV,timeIms] = ASK_keogram_overlayed(fir,las,ste,shft,width,x0,y0,angle,OPS)
...
dOPS.save4later = 0;            % save results for later, to be used with: ASK_plot_keogram_overlayed
...
if dOPS.save4later
  try
    save('data4keogram_overlayed.mat',...
         'keos','timeV','yaxis','imstack',...
         'NNN','nelem','ste','fir','las',...
         'dOPS','time_w','timeIms',...
         'ran1','ran2','ran3','calib','shft',...
         'filtStr','vs')
  catch
    disp('Failed to save data4keogram_overlayed.mat')
  end  
end
