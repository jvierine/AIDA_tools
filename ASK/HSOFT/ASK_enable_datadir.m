...
if exist(fullfile(vs.videodir,'/setup/',description_name),'file') == 2
  ...
  [~, message] = backup1000filesversions(fullfile(vs.videodir,'/setup/',description_name));
end
