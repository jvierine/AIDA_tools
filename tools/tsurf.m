function H=tcolor(x,y,z,c,varargin)
% TSURF- truecolor version of surf
% for use like surf but with c as a true color matrix (uses texturemap for speed)...
%
% H=tsurf(x,y,z,c[,method])
%
...
% H = tsurf(x,y,x+y,c,'corners')
%
% Bjorn Gustavsson -February 2022, modification of tcolor by Aslak Grinsted
% - July 2003 
...
if triangles
  H=patch(surf2patch(x,y,z,im2double(c),'triangles'),'edgecolor','none','facecolor','flat');
else
