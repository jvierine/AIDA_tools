...
% 20260125: Updated to automatically turn off zoom in the figure, and
%           then turn it back on when exiting the function if it was on./BG
zQ = zoom(gcf);
zQon = get(zQ,'enable');
zoom off
