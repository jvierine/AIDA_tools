...
% 
% Calling:
%   h = heateronoff(LEVEL, HON, HOFF [,Delta_level])
% Input:
...
%   DELTA_LEVEL - width in y-direction, optional argument. If not
%          given, lines with width 8 is used, if given patches with
%          corresponding width is produced.
% Output:
%   H - handle to the line or patch objects ploted
