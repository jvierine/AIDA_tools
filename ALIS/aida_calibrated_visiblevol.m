...
for i1 = 1:size(stn_pos,1)
  ...
  [xx,yy,zz] = inv_project_points(u,v,zeros(bxy),...
                                  r_stn(i1,:),...
                                  optpar(i1,9),optpar(i1,:),...
                                  e_n,...
                                  alt(min(end,i1)));
...
% $$$   keyboard
  ...
  if nargin > 4 && isfield(OPS,'LL')
    ...
    % BG20230425 what is this: r_stn(i1,3);
