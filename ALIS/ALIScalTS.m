function Ccam = ALIScalTS(camno,wl_NR,bin,exptime)
% ALIScalTS - Camera calibration factors calculated by Tima Sergienko
% 
% Calling:
...
% Output:
%  Ccam - Camera sensitivity (counts/R)

% Copyright Carl-Fredrik Enell 20101028
% CFE 20101028
...
switch bin
 case 1
  cft = calib(wl_NR,1,camno);
  
 case 4
  cft = calib(wl_NR,2,camno)/4;
  
 case 16
  cft = calib(wl_NR,3,camno)/16;
