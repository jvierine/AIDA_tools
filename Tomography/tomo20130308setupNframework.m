...
if strcmp(Uname,'bgu001')
  homedir = getenv('HOME'); % '/home/bgu001/';
else
end
%% 1 Locating the data
% Just set this to where the data is located on your local media.
rootD = '/'; % TODO: fix this for MS-windows-OS file-system c:-style
data_dir = fullfile(rootD,'data','NIPR');
AbiskoDir = fullfile('Abisko','2013','03','09');
TromsoDir = fullfile('Tromso','2013','03','09');
KilpisDir = fullfile('Kilpisjarvi','2013','03','09');
meta_data_dir = fullfile(rootD,'data','NIPR','Example');
cd(meta_data_dir);
...
% stick to 2012:
MSISfilename = fullfile(rootD,'data','NIPR','Example','msis20120308.dat');
