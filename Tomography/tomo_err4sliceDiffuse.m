function res = tomo_err4sliceDiffuse(Par,var_pars,par0,M2Dto1D,Ie2H,E,ImgCuts,X2D,Y2D,Z2D,biasAmplitudes,biasVals,out_arg_type,z_max,OPS)
...
for i1 = 1:(size(I0,1))
  ...
  dE0   = I0(i1,6); % Width in energy of this arc
  ...
  Ie = E.^g_E2.*exp(-abs(E-E0).^g_E/dE0^g_E).*E;
