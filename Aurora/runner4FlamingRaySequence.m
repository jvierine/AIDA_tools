...
pp8to20 = fminsearch(@(PP) err4FlamingRaySequenceP(PP,ImStack,stns,XfI,YfI,ZfI,{A1Z,A2Z},E,imbg,v_p,I0,parMin,parMax,C_filter6730,C_filter7774,errOps),PP1D,fmsOPS);
ppAll(8,:) = pp8to20;
fmsOPS.Display = 'notify';

for i1 = 5:-1:1
  errOps.timeSteps2do = i1:20;
  ppAll(i1,:) = fminsearch(@(PP) err4FlamingRaySequenceP(PP,ImStack,stns,XfI,YfI,ZfI,{A1Z,A2Z},E,imbg,v_p,I0,parMin,parMax,C_filter6730,C_filter7774,errOps),ppAll(i1+1,:),fmsOPS);
...
if 1
  ...
  PPfinAll = fminsearch(@(PP) err4FlamingRaySequenceP(PP,ImStack,stns,XfI,YfI,ZfI,{A1Z,A2Z},E,imbg,v_p,I0,parMin,parMax,C_filter6730,C_filter7774,errOps),ppAll(1,:),fmsOPS);
  save PPfinAll.mat PPfinAll
  PPfinAll = fminsearch(@(PP) err4FlamingRaySequenceP(PP,ImStack,stns,XfI,YfI,ZfI,{A1Z,A2Z},E,imbg,v_p,I0,parMin,parMax,C_filter6730,C_filter7774,errOps),PPfinAll,fmsOPS);
  save PPfinAll.mat PPfinAll
