...
load Istar It3
saveFilename = 'FlamingRay20120124TOWARDSx0y0Narrower.mat';
try
  load(saveFilename)
...
bored_to_tears = 200;
save bored_in_FlamingRay20120124TOWARDSx0y0Narrower.mat bored_to_tears
...
while not_bored_to_tears < bored_to_tears
  ...
  load bored_in_FlamingRay20120124TOWARDSx0y0Narrower.mat
