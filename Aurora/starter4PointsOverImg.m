...
% $$$               'http://www.irf.se/allsky/LASTv2.JPG'};
  UrlNames = {'http://gateway.maechan.net:9721/latest.jpg',...
              'http://kho.unis.no/Quicklooks/kho_dslr.jpg',...
              'http://gateway.maechan.net:9711/latest.jpg',...
              'http://www.irf.se/allsky/LASTv2.JPG'};
  titleStrs = {'ESR-NIPR',...
               'ESR-UNIS',...
               'Ramfjord',...
...
% $$$              [-0.7062   -0.7055    0.0781  0.0215   9.5699  -0.0051    -0.0000     0.4751  2 0]};
  optpars = {[-0.711628359192927  -0.709849642784088  -0.783205112576724  -1.714929544612530  25.481398991820324  -0.002897077735752  -0.000872938689860 0.464979247140667 2 0],...
             [-0.715667319153863  -0.715645852055462   0.265099387396843   0.028839364546578  29.559656705834207   0.011120799068716   0.012820244649586   0.524492923761308  2 0],...
             [-0.710598313352057  -0.712247032169805   0.360740538772114   0.272899399710491   2.904693549848477   0.009722221878310   0.003590593935017 0.469965733653070 2 0],...
             [-0.7062   -0.7055    0.0781  0.0215   9.5699  -0.0051    -0.0000     0.4751  2 0]};
