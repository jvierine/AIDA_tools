...
load Istar It3
saveFilename = 'FlamingRay20120124AVGx0y0Narrower.mat';
...
bored_to_tears = 200;
save bored_in_FlamingRay20120124AVGx0y0Narrower.mat bored_to_tears

fmsOPS.Display = 'iter';

while not_bored_to_tears < bored_to_tears
  
  load bored_in_FlamingRay20120124AVGx0y0Narrower.mat
