...
dirs4doc = {'ALIS','ASK/HSOFT','ASK/IC','Aurora','Camera','EARTH', ...
            'Examples','Fits_tools','Geometry','I3D','Imgtools','Inversion', ...
            'Skymap','Spectral_cal','Starcal','Tomography','tools','tools/AVPlay'};
...
m2html('mfiles',dirs4doc,...
       'htmldir','Html-D20230625',... % Default directory for documentation
