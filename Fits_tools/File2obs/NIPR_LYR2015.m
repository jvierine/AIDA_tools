function obs = NIPR_LYR2015(filename,varargin)
% NIPR_TRO2015 - Meta-data Obs-struct from filename
...
%  
% Calling:
%   obs = NIPR_TRO2015(filename,varargin)
% Input:
...
% 
% Example:
%  PO.try_to_be_smart_fnc = @(filename)NIPR_TRO2013(filename);
% 
...
T(1) =  str2num(fName(4:7));
T(2) =  str2num(fName(8:9));
T(3) =  str2num(fName(10:11));
T(4) =  str2num(fName(12:13));
T(5) =  str2num(fName(14:15));
T(6) =  str2num(fName(16:17));
if length(fName) > 17
  T(6) =  T(6) + str2num(fName(18:19))/100;
end
lambda = 427.8;
expT =  1;
