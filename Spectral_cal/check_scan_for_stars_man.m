function [ok] = check_scan_for_stars_man(files,pos,optpar,IDENTSTARS,STARPARS,PO,OPS)
...
for i = 1:size(files,1)
  ...
  this_ok = star_int_model(data,optpar,optpar(9),STars_azze,STARPARS(this_j,:),OPS,IDENTSTARS(this_j,9));
  ok = [ok;this_ok(:)];
end
