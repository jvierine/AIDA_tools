...
for ii = sis
  ...
  for iF = 1:length(uniqueFilters)
    ...
    GX{ii,iF} = I_this_star(indxCurrFilter,3)';
    GY{ii,iF} = I_this_star(indxCurrFilter,4)';
%     GX{ii,iF} = I_this_star(indxCurrFilter,2)'; Changed to adapt to
%     GY{ii,iF} = I_this_star(indxCurrFilter,3)'; spc_autoidentify 20180618
