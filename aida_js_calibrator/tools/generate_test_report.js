...
const CASES = [
    ...
    {
        id: "012165-negative-focal",
        title: "012165 optmod 2 negative focal",
        image: "2025_02_19_03_44_00_000_012165_first1s.png",
        width: 1920,
        height: 1080,
        date: new Date(Date.UTC(2025, 1, 19, 3, 44, 0)),
        ...
        matchRadiusPx: 18,
        sweepCounts: [8, 10, 12],
        detectorOptions: {maxDetections: 80},
        startMode: "as-given",
        optpar: [-0.784467, -1.392684, -60.8, 35.2, -105.5, 0.041866, 0.007995, 0.896240],
    },
    {
