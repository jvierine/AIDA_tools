...
\date{Draft for AIDA Browser Calibrator v0.2.5}
...
and exports model code that can be used outside the browser. Version 0.2.5
stabilizes the regional asterism diagnostics, allsky7 lucky recipe, and
