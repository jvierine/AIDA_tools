...
switch whichP
 ...
 case Pplot
  ...
  SkMp.prefs.pl_cl_bg = str2num(char(answer{9}));
  set(SkMp.figsky,'color',SkMp.prefs.pl_cl_bg)
  % whitebg(SkMp.prefs.pl_cl_bg)
  [SkMp] = updstrpl(SkMp);
 case Pcolor
  indx = [3 5 7 9 14];
  prompt = PROMPT(indx);
  ...
  SkMp.prefs.pl_cl_bg = str2num(char(answer{5}));
  set(SkMp.figsky,'color',SkMp.prefs.pl_cl_bg)
  % whitebg(SkMp.prefs.pl_cl_bg)
  [SkMp] = updstrpl(SkMp);
 case Psize
 ...
 case Pfigbg
  ...
  def = DEF(14);
  answer=inputdlg(prompt,title,lineNo,def);
  SkMp.prefs.pl_cl_bg = str2num(char(answer{1}));
  set(SkMp.figsky,'color',SkMp.prefs.pl_cl_bg)
  % whitebg(SkMp.prefs.pl_cl_bg)
  [SkMp] = updstrpl(SkMp);
 otherwise
