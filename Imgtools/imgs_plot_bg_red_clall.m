function out_var = imgs_plot_bg_red_clall(files,PO,nrrows,rownr,nr_imgs_per_row,ff,img_reg,u1,v1,cax,outvartype)
% imgs_plot_bg_red - Plot a row of background reduced images with colorbars
%   
% Calling:
