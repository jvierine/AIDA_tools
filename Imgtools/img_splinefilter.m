...
%   BestIndxs - indices to the best of each measure of the pdf-fits,
%               [1 x 5] int array.
%   ResPdfFit - residual between the noise-pdf and the histogram of the
%               residuals between Img_in and the respective spline-fit.
%   More_imgs - cell-array with additional output-images
...
if nargout == 0
  ...
  Measures = [stdI(min_knts:end);nfit(min_knts:end);nfit2(min_knts:end);AIC(min_knts:end);BIC(min_knts:end)];
