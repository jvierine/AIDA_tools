function [ff] = ffs_correction_raw(imgsize,optpar,optmod)
...
% 
% See also FFS_CORRECTION2 CAMERA_MODEL, DETERMINE_FOV
...
if optmod < 0
  ...
  [~,theta] = camera_invmodel(u(:),v(:),optpar,optmod,imgsize);
